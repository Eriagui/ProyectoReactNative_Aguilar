...
const MyPlacesScreen = () => {
    ...
    const getLocation = async () => {
        ...
        if (!permissionOk) {
            ...
            if (location) {
                ...
                showToast("success", "Location obtained!")
            } else {
                setErrorMsg('Error getting location');
                showToast("error", "The location was not able to be obtained")
            }
    ...
    const savePlace = () => {
        if (location && title) {
            ...
            showToast("error", "Not all data has been completed")
        }
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                <TextInput style={styles.textInput} placeholder="Location name" onChangeText={(text) => setTitle(text)} value={title} />
