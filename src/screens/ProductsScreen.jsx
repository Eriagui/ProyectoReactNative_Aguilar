            ...
            <Pressable onPress={() => {
                ...
                <FlatCard style={styles.productContainer}>
                    ...
                    <View style={styles.productDescription}>
                        ...
                        {
                            item.discount > 0 && <View style={styles.discount}><Text style={styles.discountText}>Discount {item.discount} %</Text></View>
                        }
                        <Text style={styles.price}>Price: $ {item.price} USD</Text>
                    </View>
                </FlatCard>
            </Pressable>
        )
